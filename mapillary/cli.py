...
from config import (
    get_mapillary_config, BoundingBox, CITY_BBOXES,
...
Examples:
  ...
  Show available cities:
    ...
    parser.add_argument('--output-dir', type=Path, default=None, help='Output directory for images (default: <city> or bbox# in cwd)')
