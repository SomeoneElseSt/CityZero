...
def reconstruction(database_path, image_path, output_path, image_list_path, snapshot_path, snapshot_frames_freq, input_path) -> None:
    ...
    cmd = [
        ...
        "--Mapper.ba_use_gpu", "0",                                     # Do not use GPU on AMD
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Path to directory with binaries to keep reconstructing",
    )
