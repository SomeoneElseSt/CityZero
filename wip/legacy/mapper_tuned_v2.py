...
Note: saved here for rebundancy from the Lambda. This was the only script that managed to register > 500 images and read all ~40k cameras and frames. This will be my starting point for future runs.
